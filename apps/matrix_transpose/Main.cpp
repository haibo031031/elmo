...
void mt_4(cl_mem in, cl_mem out, uint wData, uint hData);
...
/*
	opted impl. of MT on GPUs -- from AMD SDK
...
void mt_4(cl_mem in, cl_mem out, uint wData, uint hData)
{
	...
	//uint length_x = group_x + 1; // bank-conflicts removal
	//uint length_y = group_y;
	uint length_x = group_x; // bank-conflicts removal
	uint length_y = group_y;
